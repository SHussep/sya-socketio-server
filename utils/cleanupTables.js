...
const PARTIAL_CLEANUP_TABLES = [
    ...
    { name: 'production_alerts', description: 'Alertas de produccion', fkColumn: 'tenant_id' },
    { name: 'production_entries', description: 'Entradas de produccion', fkColumn: 'tenant_id' },
    { name: 'production_yield_configs', description: 'Config rendimiento produccion', fkColumn: 'tenant_id' },
