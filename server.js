...
const tenantSnapshotRoutes = require('./routes/tenant-snapshot');
...
const practiceModeRoutes = require('./routes/practice_mode');
...
app.use('/api/super-admin/backups', require('./middleware/auth').requireSuperAdminPIN, require('./routes/super-admin-backups')(pool));
...
app.use('/api/practice-mode', practiceModeRoutes(pool, io));
...
app.use('/api/tenant-snapshot', tenantSnapshotRoutes(pool));
