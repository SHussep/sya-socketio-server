...
module.exports = (pool) => {
    ...
    router.get('/shifts/:shiftId/cash-snapshot', authenticateToken, async (req, res) => {
        try {
            ...
            // Expected cash = fondo inicial + ventas efectivo - gastos
            const expectedCash = initialAmount + totalCashCollected - totalExpenses;
            ...
            const snapshot = {
                ...
                employee_role: 'repartidor',
                employee_name: `${shift.first_name} ${shift.last_name}`,
                branch_name: shift.branch_name,
                start_time: shift.start_time,
                end_time: shift.end_time,
                is_open: shift.is_cash_cut_open,
                initial_amount: initialAmount,
                cash_sales: totalCashCollected,
                card_sales: totalCardCollected,
                credit_sales: totalCreditCollected,
                cash_payments: 0,
                card_payments: 0,
                ...
                total_returned_amount: totalReturnedAmount,
                total_returned_quantity: totalReturnedQuantity,
                net_amount_to_deliver: netAmountToDeliver,
                net_quantity_delivered: totalAssignedQuantity - totalReturnedQuantity,
                actual_cash_delivered: 0,
                cash_difference: 0,
                assignment_count: parseInt(assignments.assignment_count) || 0,
                liquidated_assignment_count: parseInt(assignments.liquidated_count) || 0,
                return_count: parseInt(returns.return_count) || 0,
