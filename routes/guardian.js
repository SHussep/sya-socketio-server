    ...
    router.get('/analytics', authenticateToken, async (req, res) => {
        try {
            ...
            const [
                ...
                // scenario_code is stored as C01, C02, ..., C41 (from GuardianScenarioDefinition.Code)
                pool.query(`
                    SELECT
                        COALESCE(scenario_code, event_type) as type_key,
                        CASE COALESCE(scenario_code, event_type)
                            WHEN 'C01' THEN 'Peso no cobrado'
                            WHEN 'C02' THEN 'Multiples pesos sin cobrar'
                            WHEN 'C03' THEN 'Retiro parcial sin cobrar'
                            WHEN 'C04' THEN 'Peso fuera de ventas'
                            WHEN 'C05' THEN 'Salio de ventas con peso'
                            WHEN 'C06' THEN 'Peso sin sesion'
                            WHEN 'C07' THEN 'Pesaje abandonado'
                            WHEN 'C08' THEN 'Muchas cancelaciones'
                            WHEN 'C09' THEN 'Producto mucho tiempo en bascula'
                            WHEN 'C10' THEN 'Operacion normal'
                            WHEN 'C11' THEN 'Producto quitado antes de cobrar'
                            WHEN 'C12' THEN 'Bascula inestable'
                            WHEN 'C13' THEN 'Ajustes repetidos de peso'
                            WHEN 'C14' THEN 'Bascula desconectada'
                            WHEN 'C15' THEN 'Desconexiones frecuentes'
                            WHEN 'C16' THEN 'Reconexion con peso activo'
                            WHEN 'C17' THEN 'Sistema reiniciado'
                            WHEN 'C18' THEN 'Peso cobrado diferente al pesado'
                            WHEN 'C19' THEN 'Cobro $0 con producto en bascula'
                            WHEN 'C20' THEN 'Peso muy bajo para el producto'
                            WHEN 'C21' THEN 'Actividad fuera de horario'
                            WHEN 'C22' THEN 'Muchos eventos sospechosos'
                            WHEN 'C23' THEN 'Sin actividad en horario pico'
                            WHEN 'C24' THEN 'Cambio de usuario con peso'
                            WHEN 'C25' THEN 'Transaccion muy rapida/lenta'
                            WHEN 'C26' THEN 'Permiso especial usado'
                            WHEN 'C27' THEN 'Inventario no cuadra'
                            WHEN 'C28' THEN 'Peso no corresponde al producto'
                            WHEN 'C29' THEN 'Bascula no autorizada'
                            WHEN 'C30' THEN 'Producto pesado eliminado'
                            WHEN 'C31' THEN 'Pesaje cancelado'
                            WHEN 'C32' THEN 'Pesajes divididos'
                            WHEN 'C33' THEN 'Tiempo excedido sin confirmar'
                            WHEN 'C34' THEN 'Peso excede durante gracia'
                            WHEN 'C35' THEN 'Peso retirado sin registrar'
                            WHEN 'C36' THEN 'TARA bloqueada - peso sospechoso'
                            WHEN 'C37' THEN 'Peso negativo - error de bascula'
                            WHEN 'C38' THEN 'Producto olvidado en bascula'
                            WHEN 'C39' THEN 'Venta cancelada con productos pesados'
                            WHEN 'C40' THEN 'Segundo producto sin mover bascula'
                            WHEN 'C41' THEN 'Peso agregado despues de cobrar'
